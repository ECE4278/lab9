...
# Step 2: Read designs
# ---------------------------------------
analyze -format sverilog $env(LAB_PATH)/RTL/FIBO.sv

set design_name         FIBO
...
set_input_delay  0.65 [all_inputs]  -clock $clk_name
set_output_delay 0.65 [all_outputs] -clock $clk_name
